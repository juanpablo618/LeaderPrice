...
public class ProveedorController implements Serializable {
    ...
    @EJB
    private com.libertad6.jpacontroller.ProveedorFacade ejbFacade;
    ...
    public Proveedor getProveedor(java.lang.Integer id) {
        ...
        public String getProveedorRAZONSOCIAL(java.lang.Integer id) {
        return getFacade().find(id).getRazonSocial();
    }
