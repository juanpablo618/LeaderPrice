...
import com.libertad6.jpacontroller.PackagingFacade;
...
public class PackagingController implements Serializable {
    ...
    @EJB
    private com.libertad6.jpacontroller.PackagingFacade ejbFacade;
    ...
    public Packaging getPackaging(java.lang.Integer id) {
    ...
    public static class PackagingControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Packaging) {
                ...
                return getStringKey(o.getPackagingId());
            } else {
