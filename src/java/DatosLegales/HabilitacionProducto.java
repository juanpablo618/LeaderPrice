...
public class HabilitacionProducto implements Serializable {
    ...
    public String upload() {
        System.out.println("insertando habilitacion de Producto- into Datos legales");
        String outcome = null;        
            ...
            if(file.getFileName() == null   || (file.getFileName().equals("")) )  {
                ...
                return outcome;
                    ...
                    try {
                        ...
                        pre.setString(4,"HabilitaciónProducto");
    ...
    public void BienCreada() {
        ...
        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Habilitación de Producto", "Creado exitosamente"));
    }
