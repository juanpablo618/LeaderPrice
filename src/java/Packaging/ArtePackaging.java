...
@ManagedBean
@SessionScoped
public class ArtePackaging implements Serializable {
    ...
    public String upload() {
        System.out.println("subiendo arte de packaging");
        String outcome = null;
          ...
          if(file.getFileName() == null   || (file.getFileName().equals("")) )  {
                ...
                return outcome;
                    ...
                    try {
                        ...
                        PreparedStatement pre = con.prepareStatement("insert into packaging (FILE_ARTE_NAME,FILE_ARTE,DESARROLLO_ID,TIPO) values(?,?,?,?)");

                        pre.setString(1, file.getFileName().toString());
                        pre.setBinaryStream(2, fin2, file.getSize());
                        pre.setString(3,DESARROLLO_ID.toString());
                        pre.setString(4,"Arte");
    ...
    public void BienCreada() {
        ...
        FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Archivo de Arte", "Creado exitosamente"));
    }
